...
public class NPC_Slave3 extends Entity {


    public NPC_Slave3(GamePanel gp) {
        super(gp);
    ...
    public void getImage() {
        ...
        idle1 = setup("/npc/slave9", gp.tileSize * 2, gp.tileSize * 2);
        idle2 = setup("/npc/slave10", gp.tileSize * 2, gp.tileSize * 2);
    }
