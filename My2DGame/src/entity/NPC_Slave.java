...
public class NPC_Slave extends Entity {


    public NPC_Slave(GamePanel gp) {
        super(gp);
    ...
    public void getImage() {
        ...
        idle1 = setup("/npc/slave11", gp.tileSize * 2, gp.tileSize * 2);
        idle2 = setup("/npc/slave12", gp.tileSize * 2, gp.tileSize * 2);
    }

    public void setDialogue() {
        dialogues[0] = "Master, I'm so tired...";
