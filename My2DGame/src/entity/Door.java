...
public class Door extends Entity {
    ...
    public void getImage() {
        image = setup("/npc/Door"); // Generic sign image
    }

    // Example dialogues (can be customized per sign)
    public void setDialogue() {
        dialogues[0] = "You can't rob this house, nigga.";
        dialogues[1] = "You can't rob this house, nigga.";
        dialogues[2] = "You can't rob this house, nigga.";
