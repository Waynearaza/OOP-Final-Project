...
public class Sign2 extends Entity {

    public Sign2(GamePanel gp) {
        super(gp);
    ...
    public void setDialogue() {
        dialogues[0] = "This is Maki's home.";
        dialogues[1] = "This is Maki's home.";

        dialogues[2] = "This is Maki's home.";
